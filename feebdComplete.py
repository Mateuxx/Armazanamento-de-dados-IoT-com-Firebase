# -*- coding: utf-8 -*-
"""Copy of teste Feebd.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1E_pyPi-Q7mYmmGkjdUEGkG0FpbmdBauj
"""
...
def feedFb(device_name, dtype, valor):
    global FB_URL
    firebaseApp = firebase.FirebaseApplication(FB_URL, None)

    data = {dtype: valor,
            'time_created': datetime.datetime.now()}
    result = firebaseApp.post(f'/{device_name}/Sensor/{dtype}/', data)
